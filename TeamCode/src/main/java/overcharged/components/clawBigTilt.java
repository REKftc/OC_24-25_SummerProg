...
public class clawBigTilt {
    ...
    public static final float TRANSFER = 56f;//87f;//225f;//233f;//226f;//223f;//201f;//175f;
    ...
    public static final float OUT = 136f;//138f;
    public static final float WALL = 238f;//238f;//52f;
