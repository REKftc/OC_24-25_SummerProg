...
public class clawBigTilt {
    ...
    public static final float INIT = 93f;//230f;//90f;//70f;//230f;
    public static final float TRANSFER = 57f;//87f;//225f;//233f;//226f;//223f;//201f;//175f;
    public static final float TEMP = 222f;//188f;
    public static final float FLAT = 102f;//161f;//107f;//158f; //TODO: flat
    public static final float OUTHIGHER = 151f;//133f;//187f;//159f;//139f DONE //TODO: AUTO Specimen
    public static final float OUT = 115f;//138f; //TODO: Specimen
    public static final float WALL = 206f;//238f;//52f;
    public static final float BUCKET = 138f;
    ...
    public void setOutHigher() { clawBigTilt.setPosition(OUTHIGHER); }
