...
public class clawSmallTilt {
    ...
    public static final float TRANSFER = 108f;//125f;//122f;//130f;//188f;//183f;//177f;//171f;//175f;
    public static final float FLAT = 65f;//100f;//127f; //TODO: This is transfer Sequence
