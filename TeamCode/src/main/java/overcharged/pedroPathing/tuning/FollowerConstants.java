...
public class FollowerConstants {
    ...
    private static double xMovement = 68.4338;//67.9019;//70.7564;//68.8874;
    private static double yMovement = 50.4404;//51.7698;
    ...
    public static double forwardZeroPowerAcceleration = -33.7736;//-30.8918;//-34.62719;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -62.9829;//-60.15554;//-70.256;//-78.15554;
    ...
    public static double translationalPIDFSwitch = 4;
