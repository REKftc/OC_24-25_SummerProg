...
public class FollowerConstants {
    ...
    private static double xMovement = 72.625;//68.8874;
    private static double yMovement = 55.0313;
    ...
    public static double forwardZeroPowerAcceleration = -34.0883;//-34.62719;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -69.651;//-78.15554;
