...
@Autonomous(name = "red specimen new", group = "Autonomous")
public class autoRedSpecimenNewPath extends OpMode{
    ...
    public void firstSpecimen(){
        ...
        goPark = new Pose(119,101,Math.PI);
        goRotate = new Pose(110,109, Math.PI);
        bitForward = new Pose(123,117, Math.PI);
        ...
        switch (pathState) {
            ...
            case 16:
                if(!follower.isBusy()) {
                    ...
                    redPark2.setLinearHeadingInterpolation(goPark.getHeading(), Math.toRadians(180));
                    setPathState(17);
                }
                break;
            case 17:
            ...
            case 18:
                if(!follower.isBusy()) {
                    ...
                    nextRotate.setLinearHeadingInterpolation(goRotate.getHeading(), Math.toRadians(180));
                    setPathState(19);
                }
                break;
            case 19:
            ...
            case 21:
                if(!follower.isBusy()) {
                    ...
                    bitRotate.setLinearHeadingInterpolation(bitForward.getHeading(), Math.toRadians(180));
                    setPathState(22);
                }
                break;
            case 22:
            ...
            case 24:
                if(!follower.isBusy()) {
                    ...
                    grabSample.setLinearHeadingInterpolation(toSample.getHeading(), Math.toRadians(180));
                    setPathState(25);
                }
                break;
            case 25:
            ...
            case 26:
                if(!follower.isBusy()) {
                    robot.vSlides.moveEncoderTo(20, 1f);
                    setPathState(27);
                }
                break;
            case 27:
                if(!follower.isBusy()) {
                    ...
                    nextSample.setLinearHeadingInterpolation(secondScore.getHeading(), Math.toRadians(180));
                    robot.claw.setClose();
                    robot.clawBigTilt.setOut();
                    robot.depoHslide.setOut();
                    robot.clawSmallTilt.setFlat();
            ...
            case 28:
                if(!follower.isBusy()) {
                    ...
                    getCloser.setLinearHeadingInterpolation(bitCloser.getHeading(), Math.toRadians(180));
                    setPathState(29);
                }
                break;
            case 29:
            ...
            case 30:
                if(!follower.isBusy()) {
                    ...
                    getCloser.setLinearHeadingInterpolation(bitBitBack.getHeading(), Math.toRadians(180));
                    setPathState(31);
                }
                break;
            case 31:
