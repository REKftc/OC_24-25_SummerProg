...
@Autonomous(name = "red spec new", group = "0Autonomous")
public class autoredspecimentest extends OpMode {
    ...
    public void buildPoses() {
        ...
        goBack2 = new Pose(130, 115, Math.PI);
        ...
        goBack3 = new Pose(130, 121, Math.PI);
        getSpec2 = new Pose(126, 90, Math.PI);
        getSpec2Back = new Pose(134, 90, Math.PI);
        scoreSpec2Mid = new Pose(134, 62, Math.PI);
        scoreSpec2End = new Pose(106, 62, Math.PI);
        scoreSpec3Mid = new Pose(134, 66, Math.PI);
        scoreSpec3End = new Pose(106, 66, Math.PI);
        scoreSpec4Mid = new Pose(134, 60, Math.PI);
        scoreSpec4End = new Pose(106, 60, Math.PI);
        scoreSpec5Mid = new Pose(134, 58, Math.PI);
        scoreSpec5End = new Pose(106, 58, Math.PI);
        park = new Pose(134, 105, Math.PI);
    }
