...
public class autoRedSpecimenFive extends OpMode {
    ...
    // OTHER POSES
    private Pose beforeSpecimen, atSpecimen, backUp, goPark, goForward, goRotate, bitForward, bitBack, toSample, secondScore, bitCloser, bitBitBack, thirdSample, getThirdSample, thirdScore, thirdScoreCloser, fourthScore, fourthScoreCloser, finalPark, grabFourthSample, pushFirstSample;
    private Pose startPose = new Pose(135, 66, Math.PI);

    private Path redPark, redPark2, slightMove, nextRotate, bitRotate, toSample2, grabSample, nextSample, getCloser, getGetBack, toSample3, grabSample3, scoreSample3, scoredSample3, scoreSample4, scoredSample4, endPark, grabSample4, firstSamplePush;
    ...
    public void firstSpecimen(){
        ...
        thirdScore = new Pose(106,60, Math.PI);
    ...
    public void autoPath() {
        switch (pathState) {
            ...
            case 13: //backs away
                ...
                break;
            case 16: //goes a little in front and to the side of first sample
                if(!follower.isBusy()) {
                ...
                break;
            case 17: //goes right in front of sample
                if(!follower.isBusy()) {
                ...
                break;
            case 18: //goes right in front of sample
                if(!follower.isBusy()) {
                ...
                break;
            case 19: //pushes first sample back
                if(!follower.isBusy()) {
                ...
                break;
            case 20: //goes in front and to the side of second sample
                if(!follower.isBusy()) {
                    //follower.holdPoint(new BezierPoint(new Point(goRotate)), Math.toRadians(180));
                ...
                break;
            case 21: //goes in front of second sample
                if(!follower.isBusy()) {
                    //follower.holdPoint(new BezierPoint(new Point(goRotate)), Math.toRadians(180));
                ...
                break;
            case 22: //pushes second sample back
                if(!follower.isBusy()) {
